...
export const ITEMS = {
  // --- BRONIE ---
  sword_rusty:   { name: 'Zardzewiały miecz', icon: 'sword', type: 'weapon', price: 10,  desc: 'Stary miecz. Atak +3.', stats: { atk: 3 } },
  sword_iron:    { name: 'Żelazny miecz', icon: 'sword', type: 'weapon', price: 120, desc: 'Solidna robota kowala. Atak +7.', stats: { atk: 7 } },
  sword_steel:   { name: 'Stalowy miecz', icon: 'sword', type: 'weapon', price: 320, desc: 'Ostry jak brzytwa. Atak +12.', stats: { atk: 12 } },
  sword_knight:  { name: 'Ostrze Rycerza', icon: 'sword', type: 'weapon', price: 700, desc: 'Legendarna klinga. Atak +20.', stats: { atk: 20 } },
  crossbow:      { name: 'Kusza myśliwska', icon: 'bow', type: 'weapon', price: 380, desc: 'Strzela bełtami na odległość. Atak +10.', stats: { atk: 10 }, ranged: true },
  staff_apprentice: { name: 'Kostur ucznia', icon: 'staff', type: 'weapon', price: 260, desc: 'Wzmacnia magię. Atak +5, zaklęcia +50%.', stats: { atk: 5, spellPower: 0.5 } },
  club_goblin:   { name: 'Goblińska pałka', icon: 'mace', type: 'weapon', price: 35,  desc: 'Prymitywna, ale skuteczna. Atak +5.', stats: { atk: 5 } },
  // --- ZB BROJE ---
  armor_cloth:   { name: 'Lniana tunika', icon: 'shield', type: 'armor', price: 15,  desc: 'Lepsze niż nic. Obrona +1.', stats: { def: 1 } },
  armor_leather: { name: 'Skórzana zbroja', icon: 'shield', type: 'armor', price: 140, desc: 'Lekka i wytrzymała. Obrona +4.', stats: { def: 4 } },
  armor_chain:   { name: 'Kolczuga', icon: 'shield', type: 'armor', price: 360, desc: 'Kolcza ochrona. Obrona +8, +20 zdrowia.', stats: { def: 8, hp: 20 } },
  armor_plate:   { name: 'Płytowa zbroja', icon: 'shield', type: 'armor', price: 750, desc: 'Królewska zbroja. Obrona +14, +50 zdrowia.', stats: { def: 14, hp: 50 } },
  // --- AMULETY ---
  amulet_fire:   { name: 'Amulet Ognia', icon: 'flame', type: 'amulet', price: 220, desc: 'Dar czarodzieja. Atak +5.', stats: { atk: 5 } },
